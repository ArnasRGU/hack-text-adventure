...
function bedroom2(){
	...
	name2.innerHTML = "";
	info2.innerHTML = "";
	writeDialog('<b>07:36am. Uni successfully dodged, once again.<br>"Why would I want to live any other way? I get to spend all day doing whatever I want, with no responsibilities."<br>Cheems unearthes his laptop from the floor and brings it up to his bed.<br>~GOOD ENDING?~</B>');
}
...
function universityOutside(){
	...
	name2.innerHTML = "";
	info2.innerHTML = "";
	writeDialog("<b>Aberdeen University...<br>~END~</b>");
}
