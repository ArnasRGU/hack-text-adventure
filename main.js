...
function corridor1(){
	...
	changeImg2("");
	name2.innerHTML = "";
	writeDialog("<b>First, Art.</b>")
	getChoices(["<i>go to art class</i>"],[artClass]);
}

function artClass(){
	changeBackground("images/classroomArt.jpg");
	changeImg2("images/teacherArt.png");
	name2.style.color = "#4feb34";
	name2.innerHTML = "Art Teacher";
	info2.style.color = "#4feb34";
	info2.innerHTML = "Age: 27<br>Hates children.";
}
...
function corridor2(){
	...
	changeImg2("");
	name2.innerHTML = "";
	writeDialog("<b>Second today, Science.</b>")
...
function scienceClass(){
	...
	writeDialog('<b><span style="color:#797f99">Welcome Cheems, my least favourite student. Im going to test you with a question you will struggle to answer.<br>What is 2+2?</span></b>');
